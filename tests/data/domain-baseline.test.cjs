...
test('scene-level counts stay at the current display baseline', () => {
  ...
  assert.deepEqual(counts, [
    ...
    { scene: '1862-bunkyu', people: 24, factions: 5, relations: 20 },
    ...
    { scene: '1865-choshu', people: 32, factions: 4, relations: 27 },
    { scene: '1866-satcho', people: 29, factions: 5, relations: 27 },
    { scene: '1866-expedition', people: 30, factions: 4, relations: 25 },
    { scene: '1867-taisei', people: 30, factions: 5, relations: 21 },
    { scene: '1868-toba', people: 27, factions: 5, relations: 27 },
    { scene: '1868-edo', people: 27, factions: 4, relations: 26 },
    { scene: '1868-tohoku', people: 20, factions: 6, relations: 14 },
    { scene: '1869-hakodate', people: 17, factions: 4, relations: 11 }
  ]);
});
