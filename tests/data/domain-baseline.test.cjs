...
test('scene-level counts stay at the current display baseline', () => {
  ...
  assert.deepEqual(counts, [
    ...
    { scene: '1862-bunkyu', people: 40, factions: 7, relations: 22 },
    { scene: '1863-joi', people: 46, factions: 7, relations: 29 },
    { scene: '1863-aug18', people: 46, factions: 7, relations: 28 },
    { scene: '1864-kinmon', people: 50, factions: 7, relations: 23 },
    { scene: '1865-choshu', people: 53, factions: 7, relations: 24 },
