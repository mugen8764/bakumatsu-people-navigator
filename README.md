...
- 勢力: 11
- 時点・主要事件: 16
- 個別事件: 3（日米修好通商条約の調印・八月十八日の政変・池田屋事件）
- 人物関係: 75
- 勢力関係: 17
- 地点: 27
- 背景解説: 8項目
...
`main` のCI成功後は、CIが生成した `public-site` artifactをCloudflare Pagesへ配置します。配信成功後、本番の主要26ファイルが同じコミットの内容になったことと、4種のセキュリティヘッダー、13件のキャッシュ方針を自動確認します。
