...
- 人物中心の時点別相関図
- 池田屋事件の役割別人物カードと、事件を理解するための相関図
- 近藤勇・土方歳三の史料肖像と、画像の出典・利用条件の表示
...
`main` のCI成功後は、CIが生成した `public-site` artifactをCloudflare Pagesへ配置します。配信成功後、本番の主要18ファイルが同じコミットの内容になったことと、4種のセキュリティヘッダー、5件のキャッシュ方針を自動確認します。
