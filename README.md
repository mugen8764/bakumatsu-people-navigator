...
- 活動分野: 1（医療・学問）
- 時点・主要事件: 16
- 個別事件: 11（条約交渉、京都の政変、薩長提携、政権交替、江戸開城、会津戦争）
- 人物関係: 91
- 勢力関係: 18
- 地点: 29
- 背景解説: 19項目
...
直近の拡充範囲・掲載上の留保・理解度評価の課題は、[3テーマの情報拡充](docs/content-expansion-2026-09.md)にまとめています。
...
`main` のCI成功後は、CIが生成した `public-site` artifactをCloudflare Pagesへ配置します。配信成功後、本番の主要36ファイルが同じコミットの内容になったことと、4種のセキュリティヘッダー、21件のキャッシュ方針を自動確認します。
